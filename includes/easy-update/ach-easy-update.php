...
final class ACHUPNM_TPU_Admin {
	...
	public static function update_theme() {
		...
		require_once( ACHUPM_PATH. 'includes/easy-update/ach-theme-updater.php' );

		$upgrader = new ACHUPNM_TPU_Theme_Upgrader( new Theme_Installer_Skin( compact( 'type', 'title', 'nonce', 'url' ) ) );
	...
	public static function update_plugin() {
		...
		require_once( ACHUPM_PATH. 'includes/easy-update/ach-plugin-updater.php' );

		$upgrader = new ACHUPNM_TPU_Plugin_Upgrader( new Plugin_Installer_Skin( compact( 'type', 'title', 'nonce', 'url' ) ) );
		$result = $upgrader->install( $file_upload->package );
